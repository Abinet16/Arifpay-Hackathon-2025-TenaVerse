...
import { Mail, Lock, Eye, EyeOff, Smartphone, ArrowRight, Shield } from 'lucide-react';
...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-cyan-50 flex items-center justify-center p-4">
      ...
      {/* Centered Register Card - Smaller Size */}
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              <div className="space-y-4">
                ...
                <div className="group">
                  ...
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                      <Smartphone className="h-4 w-4 text-gray-400 group-focus-within:text-emerald-600 transition-colors" />
                    </div>
                    <input
                      id="phone"
                      name="phone"
                  ...
                  <p className="mt-1 text-xs text-gray-500">Must start with 251</p>
                </div>
