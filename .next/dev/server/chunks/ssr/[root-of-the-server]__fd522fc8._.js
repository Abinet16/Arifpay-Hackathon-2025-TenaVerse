...
api.interceptors.response.use((res)=>res, async (error)=>{
    ...
    if (error.response?.status === 401 && !originalRequest._retry && !isRefreshing) {
        ...
        try {
            ...
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`${("TURBOPACK compile-time value", "http://localhost:3000")}/api/auth/refresh`, {
                refreshToken
            });
...
function AuthProvider({ children }) {
    ...
    async function login(email, password) {
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].post("/api/users/login", {
                email,
                password
            });
            ...
            const me = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].get("/api/users/me");
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error(err.response?.data?.message || "Login failed");
        }
    }
    function logout() {
        localStorage.removeItem("token");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fd522fc8._.js.map