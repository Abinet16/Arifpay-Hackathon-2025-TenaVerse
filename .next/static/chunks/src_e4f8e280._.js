...
function AuthProvider(param) {
    ...
    async function login(email, password) {
        try {
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].post("/api/users/login", {
                email,
                password
            });
